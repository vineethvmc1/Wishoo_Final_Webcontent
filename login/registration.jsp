...
<!-- id --> 
 ...
 <!--login-->
  ...
  <div id="formContent">
    <!-- Tabs Titles -->
    <h1 style="text-align: center; font-size: 30px; padding-top: 20px;">Registration</h1>
    ...
    <!-- Login Form -->
    <form action="registrationprocess.jsp" method="post" name="myform" onsubmit="return validateform()" >
      <input type="email" id="login" class="fadeIn second" name="email" placeholder="email">
      <input type="password"  class="fadeIn third" name="password" placeholder="Password">
      <input type="password" class="fadeIn third" name="password2" placeholder="Re-Password">
      <input type="submit" class="fadeIn fourth"  onclick="matchPassword()" value="submit">
    </form>
